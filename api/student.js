...
async function learningBundle(student) {
  const enrollments = await query(
    `SELECT e.id, e.status, e.student_note, e.admin_note, e.coupon_code, e.discount_type, e.discount_value, e.discount_amount, e.payment_status, e.payment_due, e.payment_paid, e.payment_method, e.payment_reference, e.payment_date, e.payment_note, e.requested_at, e.reviewed_at, e.updated_at,
